export default async function handler(req, res) {
  try {
    ...
    if (!apiKey) {
      return res.status(500).json({ error: "Missing JUSTTCG_API_KEY in Vercel environment variables." });
    }
